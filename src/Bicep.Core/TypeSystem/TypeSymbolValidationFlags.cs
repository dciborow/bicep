...
namespace Bicep.Core.TypeSystem
{
    ...
    public enum TypeSymbolValidationFlags
    {
        ...
        /// <summary>
        /// Indicates that this type will be a String file path to a YAML file and we should offer completions for it where files wih .yaml extension are prioritised
        /// </summary>
